package com.aradsheybak.goodfood.screens.onboardings.onboardingTwo
...
fun OnboardingPage2(
    ...
    OnboardingTwoContent(onNext = onNext, onBack = onBack, onFinish = onFinish)
}

@Composable
private fun OnboardingTwoContent(
    onNext: () -> Unit = {},
    onBack: () -> Unit = {},
    onFinish: () -> Unit = {}
) {
    ConstraintLayout(
        ...
        // image
        Image(
            painter = painterResource(R.drawable.img_onboarding_two),
        ...
        // title
        Text(
            text = stringResource(R.string.title_onboarding_two),
            color = cream,
            fontSize = 32.sp,
        ...
        // description
        Text(
            text = stringResource(R.string.description_onboarding_two),
            color = cream,
            fontSize = 18.sp,
